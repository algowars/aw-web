...
declare namespace Cypress {
  ...
  interface CustomWindow extends Window {
    ...
    contactsTransactionService: typeof contactsTransactionService;
  ...
  interface Chainable {
    ...
    /**
     * Logs in via Auth0 UI flow
     */
    loginViaAuth0Ui(username: string, password: string): Chainable<any>;

    /**
     * Signs up via Auth0 UI flow
     */
    signupViaAuth0Ui(username: string, password: string): Chainable<any>;
